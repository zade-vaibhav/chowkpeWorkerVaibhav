...
const PanUpload = () => {
  ...
  const handleSubmit = async () => {
    setIsLoading(true);
    if (!fileUri?.back?.uri) {
      Alert.alert('Please upload your Pan card');
      setIsLoading(false);
      return;
    }
    try {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.profileImageContainer}>
          <Image source={require('./pancard.png')} style={styles.topImage} />
        </View>
      </View>

      <View style={styles.content}>
        <Text style={styles.uploadTitle}>
          {lang === "English" ? "Upload your Pan card" : "अपना पैन कार्ड अपलोड करें"}
        </Text>
        <Text style={styles.instructions}>
          {lang === "English"
            ? "In the next screen, you need to take a photo of your Pan card."
            : "अगली स्क्रीन में, आपको अपने पैन कार्ड की फोटो लेनी होगी।"}
        </Text>
        ...
        <View style={styles.textContainer}>
          <View style={styles.textWithIcon}>
            ...
            <Text style={styles.safeText}>
              {lang === 'English' ? 'Name, Pan Number & DOB should be clearly visible.' : 'नाम, पैन नंबर और जन्मतिथि स्पष्ट दिखाई देना चाहिए।'}
            </Text>
          </View>
          <View style={styles.textWithIcon}>
            <Image source={require('./document.png')} style={styles.icon} />
            <Text style={styles.safeText}>
              {lang === 'English' ? 'Make sure you’re uploading your Pan card. Don’t upload someone else’s Pan.' : 'सुनिश्चित करें कि आप अपना पैन कार्ड अपलोड कर रहे हैं। किसी और का पैन अपलोड न करें।'}
            </Text>
          </View>
          <View style={styles.textWithIcon}>
            <Image source={require('./document.png')} style={styles.icon} />
        ...
        <View
          ...
          <TouchableOpacity
            ...
            {fileUri?.back?.uri && (
              <Image source={{ uri: fileUri.back.uri }} style={styles.previewImage} />
            )}
