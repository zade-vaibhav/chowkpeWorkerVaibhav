    ...
    <View style={styles.container}>
      ...
      <View style={styles.topSection}>
        ...
        <View style={styles.profileImageContainer}>
          <Image source={require("./adhar.jpeg")} style={styles.topImage} />
        </View>
      </View>
      ...
      <View style={styles.content}>
        ...
        {/* <Text style={styles.fileTypeText}>File Should be in PDF, JPG</Text> */}
      </View>
...
const styles = StyleSheet.create({
  ...
  uploadButton: {
    ...
    borderRadius: 8,
    padding: 6,
    alignItems: "center", // Adjusted for spacing
    marginHorizontal: 10,
    width: "45%",
  },
  uploadButtonText: {
