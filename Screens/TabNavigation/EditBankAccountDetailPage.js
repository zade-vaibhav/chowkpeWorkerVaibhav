...
const EditBankAccountDetailPage = ({ navigation, route }) => {
  const { bankDetails} = route.params;
  const [bankAccount, setBankAccount] = useState(bankDetails?.accountNumber);
  ...
  return (
    ...
    >
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {
             lang == "English"?<Text style={styles.heading}>Change your Bank Details</Text>:<Text style={styles.heading}>अपना बैंक विवरण बदलें</Text>
          }
      ...
      <View style={styles.buttonContainer}>
        {isloading ? (
          ...
          >
            {
            lang == "English"?<Text style={styles.buttonText}>Update bank details</Text>:<Text style={styles.buttonText}>बैंक विवरण अपडेट करें</Text>
         }
...
export default EditBankAccountDetailPage;
