...
const EditAdhar = () => {
    const [fileUris, setFileUris] = useState({ front: "", back: "" });
  ...
  const handleSubmit = async () => {
    setIsLoading(true);
    if (!fileUris.front.uri || !fileUris.back.uri) {
      Alert.alert(
        "Please upload both front and back images of your Aadhar card"
      );
      setIsLoading(false);
      return;
    }
    try {
      ...
      Object.keys(fileUris).forEach((key) => {
        const fileUri = fileUris[key];
        formData.append('aadhar', {
          uri: fileUri.uri ,
          type: fileUri.mimeType || fileUri.type || "application/pdf",
          name: fileUri.fileName || fileUri.name,
        });
      });
  ...
  return (
    ...
    <Text style={styles.heading}>
      ...
      <View style={styles.profileImageContainer}>
        <Image source={require("../Documents/adhar.jpeg")} style={styles.topImage} />
      </View>
    </View>

    <View style={styles.content}>
    <Text style={styles.uploadTitle}>
          {lang == "English" ? "Upload your Aadhar card" : "अपना आधार कार्ड अपलोड करें"}
        </Text>
        <Text style={styles.instructions}>
          {lang == "English" ? "In the next screen, you need to take a photo of your Aadhar card." : "अगली स्क्रीन में, आपको अपने आधार कार्ड की फोटो लेनी होगी।"}
        </Text>

      <View style={styles.textContainer}>
        <View style={styles.textWithIcon}>
          <Image source={require("../Documents/document.png")} style={styles.icon} />
          <Text style={styles.safeText}>
              {lang == "English" ? "Name, Aadhar Number & DOB should be clearly visible." : "नाम, आधार संख्या और जन्म तिथि स्पष्ट रूप से दिखाई देनी चाहिए।"}
            </Text>
        </View>
        <View style={styles.textWithIcon}>
          <Image source={require("../Documents/document.png")} style={styles.icon} />
          <Text style={styles.safeText}>
              {lang == "English" ? "Make sure you’re uploading your Aadhar card. Don’t upload someone else’s Aadhar." : "सुनिश्चित करें कि आप अपना आधार कार्ड अपलोड कर रहे हैं। किसी और का आधार अपलोड न करें।"}
            </Text>
        </View>
        <View style={styles.textWithIcon}>
          <Image source={require("../Documents/document.png")} style={styles.icon} />
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => handleChooseFile("front")}
        >
      ...
      <Text style={styles.fileTypeText}>
          {lang === 'English' ? 'File Should be in PDF, JPG' : 'फ़ाइल PDF, JPG में होनी चाहिए'}
        </Text>
    </View>
